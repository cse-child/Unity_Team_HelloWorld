...
public class StatsUI : MonoBehaviour
{
    ...
    {
        //150.0f 부분 max부분으로
        curHP.GetComponent<RectTransform>().sizeDelta = new Vector2(494.0f / 150.0f * playerState.maxHP, 38.0f);
        curMP.GetComponent<RectTransform>().sizeDelta = new Vector2(494.0f / 150.0f * playerState.maxMP, 38.0f);
